c2.register.register('Page', {
	name: 'Tests',
	icon: 'flask',
	componentName: 'tests-management'
})
...
// lockable-by-childs
c2.register.register('VueComponent', {
	name: 'test-example-lockable-by-childs',
	options: {
		data: function (){
			return {
				childs: [1,2,3,4]
...
c2.register.register('VueComponent', {
	name: 'test-example-lockable-by-childs-child',
	options: {
		props: {
			i: {
				type: Number,
...
// lockable-by-parent
c2.register.register('VueComponent', {
	name: 'test-example-lockable-by-parent',
	options: {
		template: `<div>
			<button v-on:click="lockComponent">lock</button>
...
c2.register.register('VueComponent', {
	name: 'test-example-lockable-by-parent-child',
	options: {
		template: `<div style="background: #65075D; padding: 1em;">
			<lockable-by-parent/>
...
c2.register.register('VueComponent', {
	name: 'test-example-disabled-when-any-parent-locked',
	options: {
		template: `<div>
			<button v-on:click="lockComponent">lock</button>
			<button v-on:click="unlockComponent">unlock</button>
...
c2.register.register('VueComponent', {
	name: 'test-example-disabled-when-any-parent-locked-child',
	options: {
		template: `<div style="background: #65075D; padding: 1em;">
